...
public class SettingsFragment extends PreferencesListFragment {
			...
			public boolean onPreferenceClick(Preference preference) {
				...
				.setPositiveButton("Yes", new DialogInterface.OnClickListener() {  
				    ...
				    {  
				    	...
				    	LocalBundleData.setAccountVerified(false);
				    	AppUtil.logout();
				        dialog.cancel();
				    }  
				})    
	...
	private void hideSettings() {
		...
		hidePreference(R.string.pref_video_key);
		hidePreference(R.string.pref_call_screen_key);
		hidePreference(R.string.pref_network_screen_key);
		hidePreference(R.string.pref_advanced_screen_key);
