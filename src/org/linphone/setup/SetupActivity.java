...
public class SetupActivity extends FragmentActivity implements OnClickListener {
	...
	private WizardConfirmFragment wizardConfirmFragment;
	...
	private void initUI() {
		if (!LocalBundleData.getAccountVerified()) {
...
//			launchEchoCancellerCalibration(sendEcCalibrationResult);
	...
	public SetupFragmentsEnum getCurrentFragmentEnum() {
	...
	public void saveCreatedAccount(String username, String password, String domain) {
		...
		boolean isMainAccountLinphoneDotOrg = !getResources().getBoolean(R.bool.use_register_verify_user_webservice);
	...
	public void subscribeRegCode(String regCode) {
		wizardConfirmFragment.setRegistrationCodeGUI(regCode);
		try {
			Thread.sleep(200);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		wizardConfirmFragment.clickVerifyButton();
	}
}
