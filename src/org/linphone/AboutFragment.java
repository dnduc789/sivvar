...
public class AboutFragment extends Fragment implements OnClickListener {
	...
	TextView aboutLinkTextView = null;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		aboutLinkTextView = (TextView)view.findViewById(R.id.AboutLink);
		aboutLinkTextView.setMovementMethod(LinkMovementMethod.getInstance() );
		aboutLinkTextView.setOnClickListener( new OnClickListener() {
            @Override
