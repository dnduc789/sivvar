...
public class PassworkType extends ImageView implements AddressAware, OnClickListener, OnLongClickListener, TextWatcher{

	private AddressText address;

	public PassworkType(Context context, AttributeSet attrs) {
		super(context, attrs);
