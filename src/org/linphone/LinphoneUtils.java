...
//	}
	...
	public static void setImagePictureFromBitmap(Context c, ImageView view, Bitmap bitmap, int notFoundResource) {
		if (bitmap == null) view.setImageResource(notFoundResource);
		view.setImageBitmap(bitmap);
	}
